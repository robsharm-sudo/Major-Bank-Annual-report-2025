...
GUIDE = [
 ...
 {"chapter": "Introduction",
  ...
  "items": [
   ...
   {"k": "src", "t": "Source: PRA SS1/23 [SE]. OSFI Guideline E-23 (2027) [SE]. OCC Bulletin 2011-12 / Federal Reserve SR 11-7 [SE]."},
 ...
 {"chapter": "Scope — what is a model",
  "items": [
   ...
   {"k": "p", "req": ["M02"], "t": "The definition in CPS 240 follows the established three-part formulation: an information input component that delivers data and assumptions to the model, a processing component that transforms inputs into estimates, and a reporting component that translates the estimates into useful business information."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / Federal Reserve SR 11-7, section on the definition of a model [SE]. PRA SS1/23 Principle 1.1 Model definition [SE]. OSFI Guideline E-23 (2027), key terms [SE]."},
 ...
 {"chapter": "Proportionality and model risk tiering",
  "items": [
   ...
   {"k": "p", "req": ["M14"], "t": "The number of tiers matters less than the difference between them. Three tiers applied with genuine differentiation are more useful than five tiers that attract broadly similar treatment. If the tiering scheme does not change what actually happens to a model, it is documentation rather than control."},
   {"k": "p", "req": ["M14"], "t": "Entities should monitor the distribution of models across tiers over time. A population that migrates steadily downward, or in which very few models occupy the highest tier, warrants examination of whether the criteria are being applied as designed."},
   {"k": "h", "t": "Controlled exceptions"},
   {"k": "p", "req": ["M04"], "t": "Reduced controls should be a decision rather than an omission. An exception should identify the requirement not being met, the reason, the compensating control, the approver, the expiry date and the review point."},
   ...
   {"k": "h", "t": "Reassessment"},
   {"k": "p", "req": ["M15"], "t": "Tiers should be reassessed on a defined cycle and on the occurrence of trigger events. Triggers should include material change to the model, its data, its purpose or its user base; significant growth in the exposure or population it covers; deterioration in performance; and changes the entity did not initiate, such as a vendor version release or a change in an upstream data definition."},
   {"k": "p", "req": ["M15"], "t": "Reliance can grow without any change to the model. A model built for a small portfolio that is progressively applied to a larger one has become more material without being touched, and a reassessment cycle driven only by model change will not detect this."},
  ]},

 # ================================================================ Chapter 4
 {"chapter": "Governance and accountability",
  "items": [
   {"k": "p", "req": ["M05"], "t": "The Board should understand what the entity relies on models to do, where that reliance is concentrated, what the consequences of failure would be, how failure would be detected, and what would happen next. It is not expected to understand model methodology."},
   {"k": "src", "t": "Source: PRA SS1/23 Principle 2 Governance, and Principle 2.1 Board of directors' responsibilities [SE]. OSFI Guideline E-23 (2027) Outcome 1 and Principle 1.1 [SE]. OCC Bulletin 2011-12 / SR 11-7, governance section [SE]. CPS 220 Risk Management [B]."},
   {"k": "p", "req": ["M05", "M12"], "t": "Board reporting should support that understanding. Useful content includes the tiering profile and its movement, validation coverage and overdue validations against tier, unresolved high-severity findings and their age, material limitations accepted and the compensating controls relied on, the aggregate size and direction of overlays, model incidents, and concentration of reliance on individual providers or methods."},
   {"k": "p", "req": ["M12"], "t": "Reporting should aggregate rather than enumerate. A schedule of individual model issues does not tell the Board whether model risk is rising or falling. Trend, concentration and coverage are more informative than counts."},
   {"k": "p", "req": ["M05"], "t": "For a smaller entity, model risk reporting may sit within existing risk reporting rather than in a standalone pack, provided the Board receives the substance and can identify model risk as a distinct matter."},
   ...
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, roles and responsibilities [SE]. OSFI Guideline E-23 (2027) Principle 1.1 [SE]. ECB Guide to internal models, internal governance [SE]."},
   {"k": "h", "t": "Capability and independence"},
   {"k": "p", "req": ["M08"], "t": "Validation should be performed by people who did not build the model and who do not report to those who did or to the business sponsoring its use. Where full organisational separation is impractical, the entity should be explicit about the residual conflict and how it is managed."},
   {"k": "p", "req": ["M08"], "t": "Independence is a matter of incentive as much as of reporting line. Where a validator's workload, progression or remuneration depends on models being approved, the control is compromised regardless of the organisational structure."},
   {"k": "p", "req": ["M08"], "t": "Smaller entities may achieve independence by using qualified people from elsewhere in the entity or group who were not involved in development, or by engaging an external provider. An entity that outsources validation should retain enough capability to scope the work, understand the findings and challenge the conclusions."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, independence in validation [SE]. PRA SS1/23 Principle 4.1 The independent validation function [SE]. ECB Guide to internal models, internal validation [SE]."},
  ]},

 # ================================================================ Chapter 5
 {"chapter": "Framework, appetite and policy",
  "items": [
   {"k": "p", "req": ["M09"], "t": "The framework should treat model risk as a risk in its own right. Treating it as a category of operational risk tends to produce incident-driven management after a failure rather than lifecycle management designed to prevent one."},
   ...
   {"k": "p", "req": ["M09"], "t": "The framework should connect to, rather than duplicate, the entity's arrangements for data risk, information security, operational risk, change management, service provider management and internal audit. Where an entity operates a separate AI risk framework, the boundary between the two should be explicit."},
   {"k": "h", "t": "Model risk appetite"},
   {"k": "p", "req": ["M10"], "t": "A model risk appetite should be capable of being breached. An appetite expressed only as a statement of intent cannot be monitored and therefore cannot constrain behaviour."},
   {"k": "p", "req": ["M10"], "t": "Measurable expressions available to most entities include tolerance for the proportion of high-tier models with a current validation, the permitted number and age of unresolved high-severity findings, limits on the aggregate size of overlays relative to the modelled figure, and constraints on models operating outside approved conditions of use."},
   {"k": "p", "req": ["M10", "M40"], "t": "Entities that cannot yet quantify aggregate model risk should say so, use coverage and qualitative measures in the interim, and set out how they intend to develop the capability. An appetite deferred until quantification is available is an appetite that does not exist."},
   ...
   {"k": "p", "req": ["M11"], "t": "Policies and standards should be applied consistently across the entity. Where different businesses apply materially different development, documentation or validation standards to models of equivalent tier, the entity should be able to justify the difference on risk grounds rather than on history or convenience."},
   {"k": "src", "t": "Source: PRA SS1/23 Principle 2.3 Policies and procedures [SE]. OSFI Guideline E-23 (2027) Principle 3.1 [SE]. OCC Bulletin 2011-12 / SR 11-7, policies and controls [SE]."},
   {"k": "p", "req": ["M11"], "t": "Policies should be reviewed at least annually and version-controlled, with the substance of changes recorded. A policy library in which the current version cannot be established, or in which superseded versions remain in circulation, undermines the framework it documents."},
  ]},
 ...
 {"chapter": "Identification and inventory",
  "items": [
   ...
   {"k": "src", "t": "Source: PRA SS1/23 Principle 1.2 Model inventory [SE]. OSFI Guideline E-23 (2027) Principle 2.1, on identifying and tracking all models in use or recently decommissioned [SE]. OCC Bulletin 2011-12 / SR 11-7, model inventory [SE]."},
 ...
 {"chapter": "Development, data and documentation",
  "items": [
   {"k": "p", "req": ["M16"], "t": "Conceptual soundness asks whether the chosen approach is appropriate for the intended purpose, given the data available and the conditions in which the model will operate. It is not answered by goodness of fit. A model that fits its development sample closely may be conceptually unsound if that sample is unrepresentative of the conditions of use."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, model development, implementation and use [SE]. PRA SS1/23 Principle 3.1 Model purpose and design [SE]. OSFI Guideline E-23 (2027) Principle 3.3 [SE]."},
   {"k": "p", "req": ["M16"], "t": "Development should record the purpose the model is being built for, the design decisions taken, the theory or empirical basis for them, the variables considered and why they were retained or rejected, the assumptions on which the model depends, and the limitations that development did not resolve."},
   {"k": "p", "req": ["M16"], "t": "Reasonable alternatives should be considered and the choice recorded. Where a more transparent method would have performed acceptably, the entity should be able to explain why a less transparent one was preferred. This is not a presumption against complex methods; it is a record that the trade-off was made deliberately."},
   {"k": "p", "req": ["M16"], "t": "Development evidence should include the tests that were run and their results, including tests the model did not pass and how that was resolved. Documentation presenting only successful tests gives validation and approval an incomplete picture."},
   {"k": "h", "t": "Data"},
   {"k": "p", "req": ["M17"], "t": "Data should be assessed for appropriateness as well as accuracy. Accurate data drawn from a population, product, geography or period unlike the one in which the model will be used produces confident and wrong answers, and is a more common failure than poor data quality."},
   ...
   {"k": "p", "req": ["M17"], "t": "Entities should document data lineage to source for material models, so that a change in an upstream system or definition can be traced to the models it affects. Lineage that stops at the data warehouse does not support that assessment."},
   {"k": "p", "req": ["M17"], "t": "Where proxy or external data substitutes for insufficient internal data, the basis for considering the proxy suitable should be recorded and the sensitivity of the output to that choice should be tested. Proxies adopted at development frequently persist long after internal data has become available."},
   {"k": "p", "req": ["M17", "M33"], "t": "Synthetic data used in development or testing should be identified as such, with its generation method documented and its representativeness assessed. Testing a model on synthetic data generated from the same assumptions used to build it does not test those assumptions."},
   {"k": "h", "t": "Documentation"},
   {"k": "p", "req": ["M18"], "t": "The practical standard for documentation is reconstruction: a competent person who was not involved in the model's development should be able to pick up the documentation and reproduce its material results. Documentation that depends on the continued availability of the developer is a key-person dependency."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, documentation [SE]. PRA SS1/23 Principle 3.5 Model development documentation [SE]. ECB Guide to internal models, documentation [SE]."},
   {"k": "p", "req": ["M18"], "t": "Documentation should be maintained through the model's life. Documentation assembled in response to a validation cycle or a supervisory request describes the model as it is remembered rather than as it was built and changed."},
  ]},

 # ================================================================ Chapter 8
 {"chapter": "Testing, validation and approval",
  "items": [
   {"k": "p", "req": ["M19"], "t": "Development testing and validation are different exercises with different purposes. Development testing establishes whether the model works as its developers intended. Validation forms an independent view of whether it is fit to be relied upon."},
   ...
   {"k": "p", "req": ["M19"], "t": "Testing should use data sufficiently independent of the data used to fit the model. Out-of-sample and, where possible, out-of-time testing should be standard for higher-tier models."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, model development testing [SE]. PRA SS1/23 Principle 3.3 Model development testing [SE]."},
   {"k": "h", "t": "The three elements of validation"},
   {"k": "p", "req": ["M21"], "t": "Validation should address three complementary elements: evaluation of conceptual soundness including developmental evidence; ongoing monitoring including process verification and benchmarking; and outcomes analysis comparing model outputs with actual outcomes."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, the three core elements of model validation [SE]. PRA SS1/23 Principle 4.2 Independent review, 4.3 Process verification and 4.4 Model performance monitoring [SE]. OSFI Guideline E-23 (2027) Principle 3.4 [SE]."},
   {"k": "p", "req": ["M21"], "t": "No element is sufficient alone. Conceptual soundness cannot detect deterioration after implementation. Outcomes analysis can detect deterioration but not explain it. Process verification confirms the model was built and deployed as documented but says nothing about whether the design was appropriate."},
   {"k": "p", "req": ["M21", "M24"], "t": "Validation should test implementation as well as design — that the model as coded and running in production is the model as documented and approved. Differences in data definitions, rounding, treatment of missing values, library versions or execution order between environments can change results materially and are not detected by methodological review."},
   {"k": "p", "req": ["M21"], "t": "A validation report should reach an explicit conclusion on fitness for the intended use, with any conditions or limitations stated. A report that records observations without a conclusion leaves the approval decision without the input it was designed to receive."},
   {"k": "tbl", "caption": "Indicative validation intensity by tier. Frequencies are illustrative; entities should calibrate them and define the events that trigger validation outside the cycle.",
    ...
    "rows": [
      ...
      ["Periodic revalidation", "At least annually", "Every two to three years", "Cyclical, risk-based"],
      ["Outcomes analysis", "Continuous or quarterly, with formal backtesting", "Semi-annual or annual", "Periodic, may be qualitative"],
   ...
   {"k": "ver", "t": "Verification: the three core elements of validation are extracted from the US interagency guidance, which remains supervisory guidance rather than a regulation. Validation frequencies in the table above are illustrative drafting and are not taken from any comparator instrument; they are identified as a policy design choice in the assessment workbook."},
   {"k": "h", "t": "Effective challenge"},
   {"k": "p", "req": ["M22"], "t": "Effective challenge requires three things together: competence sufficient to identify the problem, standing sufficient for the finding to carry weight, and incentives that reward raising issues rather than clearing models. Removing any one defeats the control while leaving its documentation intact."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, effective challenge [SE]. PRA SS1/23 Principle 4 Independent model validation [SE]."},
   {"k": "p", "req": ["M22"], "t": "Indicators that challenge is not effective include findings consistently closed by explanation rather than by change, findings downgraded in severity without new evidence, validation conclusions that soften late in the approval process, and validation functions whose resourcing is set by the businesses whose models they review."},
   {"k": "p", "req": ["M22", "M42"], "t": "Entities should periodically assess whether challenge is working, rather than assuming it from the existence of a validation function. Analysis of finding closure routes, severity migration and elapsed time to remediation is more informative than validation completion rates."},
   {"k": "h", "t": "Vendor validation"},
   {"k": "p", "req": ["M20", "M31"], "t": "Vendor validation reports, certifications and third-party audit opinions may inform the entity's validation. They do not discharge it, because they are not designed around the entity's data, portfolio, controls or intended use. An entity relying on them should record what they cover and what remains for the entity to test."},
   {"k": "h", "t": "Approval"},
   {"k": "p", "req": ["M23"], "t": "Approval should be of a specific model version for a specific purpose under specific conditions. Approval expressed in general terms leaves no basis on which to determine later whether the model is being used as approved."},
   {"k": "p", "req": ["M23"], "t": "The approval record should identify the approved version, the permitted uses and users, any limits on application, the monitoring thresholds that apply, the limitations accepted and the compensating controls relied upon, and the date by which the model must be reviewed."},
   {"k": "src", "t": "Source: OSFI Guideline E-23 (2027), model approval within the model lifecycle [SE]. ECB Guide to internal models [SE]."},
   {"k": "p", "req": ["M23", "M29"], "t": "Approval despite unresolved high-severity findings should be exceptional, time-bound, supported by compensating controls and escalated to the forum that set the model risk appetite."},
  ]},

 # ================================================================ Chapter 9
 {"chapter": "Implementation, use and change",
  "items": [
   {"k": "p", "req": ["M24"], "t": "Implementation is an under-appreciated source of model failure. Validation focused on methodology will not detect that the production model differs from the approved one, and such differences arise routinely from environment, data pipeline and configuration differences rather than from deliberate change."},
   {"k": "p", "req": ["M24"], "t": "Entities should verify, before a model is relied upon in production, that it reproduces the approved model's results on a controlled set of cases, and should repeat that verification after material infrastructure or data pipeline change."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, implementation [SE]. OSFI Guideline E-23 (2027) Principle 3.5, that models should be deployed in an environment with quality and change control processes [SE]. PRA SS1/23 Principle 3.6 Supporting systems [SE]."},
   {"k": "h", "t": "Change"},
   {"k": "p", "req": ["M25"], "t": "Change assessment should consider the change both in isolation and cumulatively. A sequence of individually immaterial recalibrations can move a model materially away from the version that was validated, and change frameworks that assess only the increment will not detect this."},
   {"k": "p", "req": ["M25"], "t": "Changes the entity did not initiate are still changes to its model risk profile. A vendor version release, a change in an upstream data definition, a change in the composition of a portfolio the model is applied to, or a change in the regulatory basis of a calculation should each enter the change assessment."},
   {"k": "src", "t": "Source: ECB Guide to internal models, management of model changes [SE]. OSFI Guideline E-23 (2027) Principle 3.5 [SE]."},
   {"k": "h", "t": "Use"},
   {"k": "p", "req": ["M26"], "t": "Misuse of a sound model is one of the two recognised sources of model risk and is frequently the less well controlled. Common patterns include applying a model built to rank relative risk to set absolute prices, applying a model developed on one portfolio to another, and continuing to rely on a model in conditions it was known not to cover."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, the two sources of model risk [SE]. PRA SS1/23 Principle 3 [SE]. ECB Guide to internal models, use test [SE]."},
   ...
   {"k": "p", "req": ["M27"], "t": "Adjustments to model output should be governed with the same discipline as the model. The basis, the quantification, the approver, the duration and the conditions for removal should each be recorded."},
   ...
   {"k": "p", "req": ["M27"], "t": "A persistent overlay in a consistent direction is evidence about the model rather than a correction to it. Where an entity has adjusted a model's output in the same direction for successive periods, the appropriate response is usually redevelopment rather than continued adjustment."},
   {"k": "p", "req": ["M27", "M12"], "t": "Overlays should be reported in aggregate. Individually approved adjustments can collectively become the dominant driver of a reported figure without any single approval having considered that effect."},
 ...
 {"chapter": "Monitoring, mitigants and retirement",
  "items": [
   {"k": "p", "req": ["M28"], "t": "Monitoring should test whether the conditions that made the model valid continue to hold, not only whether its output has moved. A model can produce stable output while the relationships it depends on have broken down."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, ongoing monitoring [SE]. PRA SS1/23 Principle 4.4 Model performance monitoring [SE]. OSFI Guideline E-23 (2027) Principle 3.6 [SE]."},
   {"k": "p", "req": ["M28"], "t": "Thresholds should be set in advance and linked to a defined response — investigation, escalation, restriction of use, revalidation, overlay or withdrawal. A threshold that produces a note rather than an action is not a control."},
   {"k": "p", "req": ["M28"], "t": "Monitoring should cover input data as well as output. Shifts in the distribution, completeness or definition of inputs frequently precede deterioration in output and provide earlier warning."},
   {"k": "h", "t": "Limitations and remediation"},
   {"k": "p", "req": ["M29"], "t": "Compensating controls should be specific to the limitation they address. A general statement that outputs are subject to management review does not compensate for a known bias in a particular segment, because it does not direct attention to that segment."},
   {"k": "src", "t": "Source: PRA SS1/23 Principle 5 Model risk mitigants, and Principle 5.2 Restrictions on model use [SE]."},
   {"k": "p", "req": ["M29"], "t": "Entities should monitor how findings are closed. A high proportion closed by rationale, deferral or reclassification rather than by change indicates that remediation is not functioning, even where closure rates appear satisfactory."},
   {"k": "h", "t": "Restriction, suspension and retirement"},
   {"k": "p", "req": ["M30"], "t": "An entity should know in advance what it would do if a material model became unusable — whether an alternative exists, how long it would take to bring into service, and what the interim basis for decisions would be. For models supporting a critical operation, this should be tested."},
   {"k": "src", "t": "Source: OSFI Guideline E-23 (2027) Principle 3.6, model decommission [SE]. CPS 230 Operational Risk Management [B]."},
   {"k": "p", "req": ["M30"], "t": "Decommissioning should address downstream models that consume the retired model's output, decisions and balances that remain in force, retained records, and the disposition of data. Retirement that switches off the model without addressing its residue leaves risk in place without an owner."},
  ]},

 # ================================================================ Chapter 11
 {"chapter": "Third-party models",
  "items": [
   {"k": "p", "req": ["M31"], "t": "A third-party model is subject to the same framework as an internally developed one. The entity's ability to inspect it is lower, which increases rather than reduces the work required to gain assurance."},
   {"k": "src", "t": "Source: OCC Bulletin 2011-12 / SR 11-7, vendor and third-party models [SE]. PRA SS1/23 Principle 2.6 Use of externally developed models, third-party vendor products [SE]. OSFI Guideline E-23 (2027), third-party models [SE]."},
   {"k": "p", "req": ["M31"], "t": "Where a provider will not disclose methodology, the entity should intensify what it can do independently: benchmarking against an alternative, outcomes analysis on its own portfolio, sensitivity testing through controlled variation of inputs, and tighter conditions of use. Opacity should narrow the approved use, not widen the tolerance."},
   {"k": "p", "req": ["M31"], "t": "An entity should not accept from a provider a level of opacity it would not accept from an internal development team for a model of the same tier."},
 ...
 {"chapter": "Specialist model classes",
  "items": [
   ...
   {"k": "p", "req": ["M38"], "t": "Liquidity models supporting investment strategy should be tested against the conditions in which they would actually be relied upon, rather than against normal conditions in which liquidity is not in question."},
   ...
   {"k": "p", "req": ["M39"], "t": "Stress testing models are used where historical data is least informative, so their results depend heavily on assumption and expert judgement. That makes the governance of assumptions the principal control rather than a reason to reduce governance."},
   {"k": "src", "t": "Source: BCBS Stress testing principles [B where implemented]. CPS 220 Risk Management [B]."},
   {"k": "p", "req": ["M39"], "t": "Forward-looking scenario models addressing risks with limited historical precedent, including climate scenarios, should be presented to decision-makers with the uncertainty in their outputs made explicit, and should not be reported with a precision the method cannot support."},
  ]},

 # ================================================================ Chapter 14
 {"chapter": "Aggregate model risk, records and assurance",
  "items": [
   {"k": "p", "req": ["M40"], "t": "Aggregate assessment need not begin with quantification. Concentration of reliance, correlation of method and data across models, common assumptions, and the extent of unvalidated or overdue models are all informative and are generally available before a quantification capability exists."},
   {"k": "src", "t": "Source: PRA SS1/23 Principle 5 [SE]. ECB supervisory review of model risk [SE]."},
   {"k": "p", "req": ["M40"], "t": "Where an entity concludes that no capital is warranted in respect of model risk, that conclusion should be reasoned and recorded. Reaching it by omission is not a conclusion."},
   {"k": "p", "req": ["M40"], "t": "Correlation deserves particular attention. Models that share a data source, a vendor, a core assumption or a development team can fail together, and an aggregate view built by summing independent assessments will understate that exposure."},
   {"k": "h", "t": "Records"},
   {"k": "p", "req": ["M41"], "t": "Reconstructability allows a supervisor, auditor, actuary or court to establish what the entity knew and when. It should be designed into the model's operation rather than assembled after the event, because the records that matter most are usually those not retained by default."},
   {"k": "p", "req": ["M41"], "t": "Retention periods should align with the entity's other prudential record-keeping obligations and with the period over which the decisions the model informed remain material. For long-tail insurance liabilities and superannuation member outcomes, that period can be considerably longer than for credit decisions."},
   {"k": "h", "t": "Assurance"},
   {"k": "p", "req": ["M42"], "t": "Internal audit's role is to assess whether the framework works, not to re-perform validation. Testing whether findings are genuinely resolved, whether tiering is applied consistently across businesses, and whether the inventory is complete is generally more informative than re-examining model methodology."},
   {"k": "src", "t": "Source: PRA SS1/23 Principle 2.5 Internal Audit [SE]. OCC Bulletin 2011-12 / SR 11-7, internal audit [SE]. ECB Guide to internal models, internal audit [SE]."},
