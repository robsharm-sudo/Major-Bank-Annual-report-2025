...
GUIDE = [
 ...
 {"chapter": "Framework, appetite and policy",
  "items": [
   ...
   {"k": "p", "req": ["M11", "M41"], "t": "Entities that cannot yet quantify aggregate model risk should say so, use coverage and qualitative measures in the interim, and set out how they intend to develop the capability. An appetite deferred until quantification is available is an appetite that does not exist."},
 ...
 {"chapter": "Testing, validation and approval",
  "items": [
   ...
   {"k": "p", "req": ["M23", "M43"], "t": "Entities should periodically assess whether challenge is working, rather than assuming it from the existence of a validation function. Analysis of finding closure routes, severity migration and elapsed time to remediation is more informative than validation completion rates."},
 ...
 {"chapter": "Specialist model classes",
  "items": [
   ...
   {"k": "p", "req": ["M38"], "t": "For an insurer, the Appointed Actuary framework already provides a form of independent professional review that will discharge a substantial part of the validation expectation for many actuarial models. It does not automatically discharge all of it, particularly implementation verification and data quality assessment."},
   {"k": "p", "req": ["M38"], "t": "Insurers should map which elements of CPS XXXX validation are met through the actuarial control cycle and which require separate work, rather than assuming complete overlap in either direction. The mapping should be documented and reviewed."},
   ...
   {"k": "p", "req": ["M39"], "t": "For an RSE licensee, unit pricing and asset valuation models directly determine amounts credited to member accounts. An error is realised as a transfer of value between members and is frequently difficult to reverse, which places these models at the higher end of any reasonable tiering assessment."},
   {"k": "p", "req": ["M39"], "t": "Liquidity models supporting investment strategy should be tested against the conditions in which they would actually be relied upon, rather than against normal conditions in which liquidity is not in question."},
   ...
   {"k": "p", "req": ["M40"], "t": "Stress testing models are used where historical data is least informative, so their results depend heavily on assumption and expert judgement. That makes the governance of assumptions the principal control rather than a reason to reduce governance."},
   {"k": "src", "t": "Source: BCBS Stress testing principles [G]. CPS 220 Risk Management [B]."},
   {"k": "p", "req": ["M40"], "t": "Forward-looking scenario models addressing risks with limited historical precedent, including climate scenarios, should be presented to decision-makers with the uncertainty in their outputs made explicit, and should not be reported with a precision the method cannot support."},
  ]},

 # ================================================================ Chapter 14
 {"chapter": "Aggregate model risk, records and assurance",
  "items": [
   {"k": "p", "req": ["M41"], "t": "Aggregate assessment need not begin with quantification. Concentration of reliance, correlation of method and data across models, common assumptions, and the extent of unvalidated or overdue models are all informative and are generally available before a quantification capability exists."},
   {"k": "src", "t": "Source: PRA SS1/23 Principle 5 [SE]. ECB supervisory review of model risk [SE]."},
   {"k": "p", "req": ["M41"], "t": "Where an entity concludes that no capital is warranted in respect of model risk, that conclusion should be reasoned and recorded. Reaching it by omission is not a conclusion."},
   {"k": "p", "req": ["M41"], "t": "Correlation deserves particular attention. Models that share a data source, a vendor, a core assumption or a development team can fail together, and an aggregate view built by summing independent assessments will understate that exposure."},
   {"k": "h", "t": "Records"},
   {"k": "p", "req": ["M42"], "t": "Reconstructability allows a supervisor, auditor, actuary or court to establish what the entity knew and when. It should be designed into the model's operation rather than assembled after the event, because the records that matter most are usually those not retained by default."},
   {"k": "p", "req": ["M42"], "t": "Retention periods should align with the entity's other prudential record-keeping obligations and with the period over which the decisions the model informed remain material. For long-tail insurance liabilities and superannuation member outcomes, that period can be considerably longer than for credit decisions."},
   {"k": "h", "t": "Assurance"},
   {"k": "p", "req": ["M43"], "t": "Internal audit's role is to assess whether the framework works, not to re-perform validation. Testing whether findings are genuinely resolved, whether tiering is applied consistently across businesses, and whether the inventory is complete is generally more informative than re-examining model methodology."},
   ...
   {"k": "p", "req": ["M43"], "t": "Where internal audit lacks the technical capability to assess validation quality, the entity should obtain that capability, through co-sourcing or specialist recruitment, rather than narrow the scope of the assurance to what the existing team can cover."},
   {"k": "h", "t": "Engagement with APRA"},
   {"k": "p", "req": ["M44"], "t": "Early engagement is expected where an entity identifies a material weakness in a model used for regulatory capital, reserving or reporting. Engagement at the point the correction is finalised gives APRA no opportunity to consider the issue while options remain open."},
   {"k": "p", "req": ["M44"], "t": "Where a model failure is also an operational risk or information security incident, the notification requirements of the applicable prudential standards apply. CPS XXXX does not create a separate or conflicting deadline."},
