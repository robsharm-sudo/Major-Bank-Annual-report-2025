...
GUIDE = [
 ...
 {"chapter": "Expected credit loss and provisioning models",
  ...
  "items": [
   ...
   {"k": "p", "req": ["M38", "M41"], "t": "Sensitivity analysis is how an entity demonstrates that it understands what its provision depends on. APRA expects comprehensive sensitivity analysis to be performed on a regular and timely basis across credit portfolios, segmented by industry, geography and other relevant dimensions, so that management and the Board can see how provisions respond to changes in the key underlying drivers of credit risk."},
   {"k": "p", "req": ["M38", "M41"], "t": "This analysis can form part of the entity's broader stress testing capability and inform the internal capital adequacy assessment process and risk appetite review. The same governance expectations apply to it as to the models: clear accountabilities, robust controls and oversight over both the process and the decisions taken from it."},
   ...
   {"k": "ver", "t": "Verification: the special purpose engagement provisions of APS 310, GPS 310, LPS 310, HPS 310 and SPS 310 were each read from the primary instrument on 25 July 2026, as was the Special purpose engagements provision of APS 220. Paragraph numbers are not asserted because the published renderings do not carry them; each provision is cited by its section heading. An earlier draft stated that no such power reached insurers or RSE licensees. That was wrong, was corrected on examination of the Audit and Related Matters standards, and is recorded in the red-team audit trail."},
  ]},
