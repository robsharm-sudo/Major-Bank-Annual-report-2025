...
```
build/
  content_requirements.py   the 43 mandatory requirements, with provenance and rationale
...
The package was red-teamed against primary sources across five challenge lenses and 49
